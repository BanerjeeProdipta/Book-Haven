            ...
            >
              <div className="flex flex-col items-center mr-4">
                <button
                  ...
                  className="border border-gray-300 w-20 rounded-md px-2 py-1 text-center"
                >
                  +
                </button>
                <input
                  type="number"
                  className="border border-gray-300 w-20 font-semibold rounded-md px-2 py-1 text-center my-2"
                  value={quantity}
                  onChange={(e) =>
